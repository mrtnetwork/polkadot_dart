...
abstract class XCMV5NetworkId extends SubstrateVariantSerialization
  ...
  factory XCMV5NetworkId.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMNetworkIdType.byGenesis => XCMV5ByGenesis.deserializeJson(
        decode.value,
      ),
      ...
      XCMNetworkIdType.bitcoinCash => XCMV5BitcoinCash.deserializeJson(
        decode.value,
      ),
      XCMNetworkIdType.bitcoinCore => XCMV5BitcoinCore.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV5NetworkId.from(XCMNetworkId network) {
    ...
    return switch (type) {
      XCMNetworkIdType.byGenesis => XCMV5ByGenesis(
      ...
      XCMNetworkIdType.ethereum => XCMV5Ethereum(
...
abstract class XCMV5AssetInstance extends SubstrateVariantSerialization
  ...
  factory XCMV5AssetInstance.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMAssetInstanceType.indexId => XCMV5AssetInstanceIndex.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array4 => XCMV5AssetInstanceArray4.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array8 => XCMV5AssetInstanceArray8.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array16 => XCMV5AssetInstanceArray16.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array32 => XCMV5AssetInstanceArray32.deserializeJson(
        decode.value,
      ),
    };
  }
  factory XCMV5AssetInstance.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMAssetInstanceType.undefined => XCMV5AssetInstanceUndefined.fromJson(
        json,
      ),
...
class XCMV5AssetInstanceIndex extends XCMV5AssetInstance
  ...
  @override
  final BigInt index;
  XCMV5AssetInstanceIndex({required BigInt index}) : index = index.asU128;
  ...
  XCMV5AssetInstanceArray4({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 4,
                operation: "XCMV5AssetInstanceArray4",
                name: "datum",
  ...
  XCMV5AssetInstanceArray8({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 8,
                operation: "XCMV5AssetInstanceArray8",
                name: "datum",
                reason: "Invalid datum bytes length.",
              )
              .asImmutableBytes;
  ...
  XCMV5AssetInstanceArray16({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 16,
                operation: "XCMV5AssetInstanceArray16",
                name: "datum",
                reason: "Invalid datum bytes length.",
              )
              .asImmutableBytes;
  ...
  XCMV5AssetInstanceArray32({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 32,
                operation: "XCMV5AssetInstanceArray32",
                name: "datum",
                reason: "Invalid datum bytes length.",
              )
              .asImmutableBytes;
...
abstract class XCMV5Junction extends SubstrateVariantSerialization
  ...
  factory XCMV5Junction.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMJunctionType.parachain => XCMV5JunctionParaChain.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.accountId32 => XCMV5JunctionAccountId32.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.accountIndex64 =>
        XCMV5JunctionAccountIndex64.deserializeJson(decode.value),
      XCMJunctionType.accountKey20 => XCMV5JunctionAccountKey20.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.palletInstance =>
        XCMV5JunctionPalletInstance.deserializeJson(decode.value),
      XCMJunctionType.generalIndex => XCMV5JunctionGeneralIndex.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.generalKey => XCMV5JunctionGeneralKey.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.onlyChild => XCMV5JunctionOnlyChild.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.plurality => XCMV5JunctionPlurality.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV5Junction.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMJunctionType.accountIndex64 => XCMV5JunctionAccountIndex64.fromJson(
        json,
      ),
      XCMJunctionType.accountKey20 => XCMV5JunctionAccountKey20.fromJson(json),
      XCMJunctionType.palletInstance => XCMV5JunctionPalletInstance.fromJson(
        json,
      ),
      ...
      XCMJunctionType.globalConsensus => XCMV5JunctionGlobalConsensus.fromJson(
        json,
      ),
    };
  }
  ...
  factory XCMV5Junction.from(XCMJunction junction) {
    ...
    return switch (type) {
      XCMJunctionType.parachain => XCMV5JunctionParaChain(
...
class XCMV5JunctionParaChain extends XCMV5Junction with XCMJunctionParaChain {
  @override
  final int id;
  XCMV5JunctionParaChain({required int id}) : id = id.asU32;
    ...
    : id =
          id
              .exc(
                ...
                operation: "XCMV5JunctionAccountId32",
                name: "id",
    ...
    : key =
          key
              .exc(
                ...
                operation: "XCMV5JunctionAccountKey20",
                name: "key",
...
class XCMV5JunctionPalletInstance extends XCMV5Junction
  ...
  @override
  final int index;
  XCMV5JunctionPalletInstance({required int index}) : index = index.asU8;
...
class XCMV5JunctionGeneralIndex extends XCMV5Junction
  ...
  @override
  final BigInt index;
  XCMV5JunctionGeneralIndex({required BigInt index}) : index = index.asU128;
    ...
    : length = length.asU8,
      data =
          data
              .exc(
                length: SubstrateConstant.accountIdLengthInBytes,
                operation: "XCMV5JunctionGeneralKey",
                name: "data",
...
abstract class XCMV5Junctions extends XCMJunctions<XCMV5Junction> {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      LazyVariantModel(
        layout: ({property}) => XCMV5JunctionsHere.layout_(property: property),
        property: XCMJunctionsType.here.name,
        index: 0,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMV5JunctionsX1.layout_(
              XCMJunctionsType.x1,
              property: property,
            ),
...
abstract class XCMV5Fungibility extends SubstrateVariantSerialization
  ...
  factory XCMV5Fungibility.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMFungibilityType.fungible => XCMV5FungibilityFungible.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV5Fungibility.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMFungibilityType.nonFungible => XCMV5FungibilityNonFungible.fromJson(
        json,
      ),
    };
  }
...
class XCMV5FungibilityFungible extends XCMV5Fungibility
  ...
  XCMV5FungibilityFungible({required BigInt units}) : units = units.asU128;
...
abstract class XCMV5WildFungibility extends SubstrateVariantSerialization
  ...
  factory XCMV5WildFungibility.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMWildFungibilityType.fungible => XCMV5WildFungibilityFungible.fromJson(
        json,
      ),
      XCMWildFungibilityType.nonFungible =>
...
class XCMV5AssetId extends SubstrateSerialization<Map<String, dynamic>>
  ...
  factory XCMV5AssetId.from(XCMAssetId id) {
    return switch (id) {
      ...
      final XCMV4AssetId assetId => XCMV5AssetId(
        location: assetId.location.asVersion(XCMVersion.v5),
      ),
...
abstract class XCMV5WildAsset extends SubstrateVariantSerialization
  ...
  factory XCMV5WildAsset.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMWildAssetType.allOf => XCMV5WildAssetAllOf.deserializeJson(
        decode.value,
      ),
      XCMWildAssetType.allCounted => XCMV5WildAssetAllCounted.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV5WildAsset.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMWildAssetType.allOfCounted => XCMV5WildAssetAllOfCounted.fromJson(
        json,
      ),
    };
  }
...
class XCMV5WildAssetAllCounted extends XCMV5WildAsset
  ...
  @override
  final int count;
  XCMV5WildAssetAllCounted({required int count}) : count = count.asU32;
...
abstract class XCMV5AssetFilter extends SubstrateVariantSerialization
  ...
  factory XCMV5AssetFilter.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMMultiAssetFilterType.wild => XCMV5AssetFilterWild.deserializeJson(
        decode.value,
      ),
    };
  }
  factory XCMV5AssetFilter.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMMultiAssetFilterType.definite => XCMV5AssetFilterDefinite.fromJson(
        json,
      ),
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      ...
      LazyVariantModel(
        layout:
            ({property}) => XCMV5AssetFilterWild.layout_(property: property),
...
class XCMV5AssetFilterWild extends XCMV5AssetFilter
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV5WildAsset.layout_(property: "asset"),
    ], property: property);
  }
