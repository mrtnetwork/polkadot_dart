...
abstract class XCMV4NetworkId extends SubstrateVariantSerialization
  ...
  factory XCMV4NetworkId.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMNetworkIdType.byGenesis => XCMV4ByGenesis.deserializeJson(
        decode.value,
      ),
      ...
      XCMNetworkIdType.bitcoinCash => XCMV4BitcoinCash.deserializeJson(
        decode.value,
      ),
      XCMNetworkIdType.bitcoinCore => XCMV4BitcoinCore.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV4NetworkId.from(XCMNetworkId network) {
    ...
    return switch (type) {
      XCMNetworkIdType.byGenesis => XCMV4ByGenesis(
      ...
      XCMNetworkIdType.ethereum => XCMV4Ethereum(
...
abstract class XCMV4Junction extends SubstrateVariantSerialization
  ...
  factory XCMV4Junction.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMJunctionType.parachain => XCMV4JunctionParaChain.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.accountId32 => XCMV4JunctionAccountId32.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.accountIndex64 =>
        XCMV4JunctionAccountIndex64.deserializeJson(decode.value),
      XCMJunctionType.accountKey20 => XCMV4JunctionAccountKey20.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.palletInstance =>
        XCMV4JunctionPalletInstance.deserializeJson(decode.value),
      XCMJunctionType.generalIndex => XCMV4JunctionGeneralIndex.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.generalKey => XCMV4JunctionGeneralKey.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.onlyChild => XCMV4JunctionOnlyChild.deserializeJson(
        decode.value,
      ),
      XCMJunctionType.plurality => XCMV4JunctionPlurality.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV4Junction.from(XCMJunction junction) {
    ...
    return switch (type) {
      XCMJunctionType.parachain => XCMV4JunctionParaChain(
  ...
  factory XCMV4Junction.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMJunctionType.accountIndex64 => XCMV4JunctionAccountIndex64.fromJson(
        json,
      ),
      XCMJunctionType.accountKey20 => XCMV4JunctionAccountKey20.fromJson(json),
      XCMJunctionType.palletInstance => XCMV4JunctionPalletInstance.fromJson(
        json,
      ),
      ...
      XCMJunctionType.globalConsensus => XCMV4JunctionGlobalConsensus.fromJson(
        json,
      ),
    };
  }
...
class XCMV4JunctionParaChain extends XCMV4Junction with XCMJunctionParaChain {
  @override
  final int id;
  XCMV4JunctionParaChain({required int id}) : id = id.asU32;
    ...
    : id =
          id
              .exc(
                ...
                operation: "XCMV4JunctionAccountId32",
                name: "id",
    ...
    : key =
          key
              .exc(
                ...
                operation: "XCMV4JunctionAccountKey20",
                name: "key",
...
class XCMV4JunctionPalletInstance extends XCMV4Junction
  ...
  @override
  final int index;
  XCMV4JunctionPalletInstance({required int index}) : index = index.asU8;
...
class XCMV4JunctionGeneralIndex extends XCMV4Junction
  ...
  @override
  final BigInt index;
  XCMV4JunctionGeneralIndex({required BigInt index}) : index = index.asU128;
    ...
    : length = length.asU8,
      data =
          data
              .exc(
                length: SubstrateConstant.accountIdLengthInBytes,
                operation: "XCMV4JunctionGeneralKey",
                name: "data",
...
abstract class XCMV4Junctions extends XCMJunctions<XCMV4Junction> {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      LazyVariantModel(
        layout: ({property}) => XCMV4JunctionsHere.layout_(property: property),
        property: XCMJunctionsType.here.name,
        index: 0,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMV4JunctionsX1.layout_(
              XCMJunctionsType.x1,
              property: property,
            ),
...
abstract class XCMV4AssetInstance extends SubstrateVariantSerialization
  ...
  factory XCMV4AssetInstance.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMAssetInstanceType.indexId => XCMV4AssetInstanceIndex.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array4 => XCMV4AssetInstanceArray4.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array8 => XCMV4AssetInstanceArray8.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array16 => XCMV4AssetInstanceArray16.deserializeJson(
        decode.value,
      ),
      XCMAssetInstanceType.array32 => XCMV4AssetInstanceArray32.deserializeJson(
        decode.value,
      ),
    };
  }
  ...
  factory XCMV4AssetInstance.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMAssetInstanceType.undefined => XCMV4AssetInstanceUndefined.fromJson(
        json,
      ),
...
class XCMV4AssetInstanceIndex extends XCMV4AssetInstance
  ...
  @override
  final BigInt index;
  XCMV4AssetInstanceIndex({required BigInt index}) : index = index.asU128;
  ...
  XCMV4AssetInstanceArray4({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 4,
                operation: "XCMV4AssetInstanceArray4",
                name: "datum",
  ...
  XCMV4AssetInstanceArray8({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 8,
                operation: "XCMV4AssetInstanceArray8",
                name: "datum",
                reason: "Invalid datum bytes length.",
              )
              .asImmutableBytes;
  ...
  XCMV4AssetInstanceArray16({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 16,
                operation: "XCMV4AssetInstanceArray16",
                name: "datum",
                reason: "Invalid datum bytes length.",
              )
              .asImmutableBytes;
  ...
  XCMV4AssetInstanceArray32({required List<int> datum})
    : datum =
          datum
              .exc(
                length: 32,
                operation: "XCMV4AssetInstanceArray32",
                name: "datum",
                reason: "Invalid datum bytes length.",
              )
              .asImmutableBytes;
...
abstract class XCMV4Fungibility extends SubstrateVariantSerialization
  ...
  factory XCMV4Fungibility.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMFungibilityType.fungible => XCMV4FungibilityFungible.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV4Fungibility.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMFungibilityType.nonFungible => XCMV4FungibilityNonFungible.fromJson(
        json,
      ),
    };
  }
...
class XCMV4FungibilityFungible extends XCMV4Fungibility
  ...
  @override
  final BigInt units;
  XCMV4FungibilityFungible({required BigInt units}) : units = units.asU128;
...
abstract class XCMV4WildFungibility extends SubstrateVariantSerialization
  ...
  factory XCMV4WildFungibility.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMWildFungibilityType.fungible => XCMV4WildFungibilityFungible.fromJson(
        json,
      ),
      XCMWildFungibilityType.nonFungible =>
...
class XCMV4AssetId extends SubstrateSerialization<Map<String, dynamic>>
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV4Location.layout_(property: "location"),
    ], property: property);
  }
  ...
  factory XCMV4AssetId.from(XCMAssetId id) {
    return switch (id) {
      ...
      final XCMV5AssetId assetId => XCMV4AssetId(
        location: assetId.location.asVersion(XCMVersion.v4),
      ),
...
abstract class XCMV4WildAsset extends SubstrateVariantSerialization
  ...
  factory XCMV4WildAsset.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMWildAssetType.allOf => XCMV4WildAssetAllOf.deserializeJson(
        decode.value,
      ),
      XCMWildAssetType.allCounted => XCMV4WildAssetAllCounted.deserializeJson(
        decode.value,
      ),
  ...
  factory XCMV4WildAsset.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMWildAssetType.allOfCounted => XCMV4WildAssetAllOfCounted.fromJson(
        json,
      ),
    };
  }
...
class XCMV4WildAssetAllCounted extends XCMV4WildAsset
  ...
  @override
  final int count;
  XCMV4WildAssetAllCounted({required int count}) : count = count.asU32;
...
abstract class XCMV4AssetFilter extends SubstrateVariantSerialization
  ...
  factory XCMV4AssetFilter.deserializeJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      XCMMultiAssetFilterType.wild => XCMV4AssetFilterWild.deserializeJson(
        decode.value,
      ),
    };
  }
  factory XCMV4AssetFilter.fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      XCMMultiAssetFilterType.definite => XCMV4AssetFilterDefinite.fromJson(
        json,
      ),
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      ...
      LazyVariantModel(
        layout:
            ({property}) => XCMV4AssetFilterWild.layout_(property: property),
...
class XCMV4AssetFilterWild extends XCMV4AssetFilter
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV4WildAsset.layout_(property: "asset"),
    ], property: property);
  }
