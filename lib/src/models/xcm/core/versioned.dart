...
abstract class XCMVersionedXCM extends SubstrateVariantSerialization {
  ...
  factory XCMVersionedXCM.fromJson(
...
class XCMVersionedXCMV2 extends XCMVersionedXCM {
  ...
  factory XCMVersionedXCMV2.fromJson(Map<String, dynamic> json) {
    final data = json.valueEnsureAsList<Map<String, dynamic>>(
      XCMVersion.v2.type,
    );

    return XCMVersionedXCMV2(
      xcm: XCMV2(
        instructions: data.map((e) => XCMInstructionV2.fromJson(e)).toList(),
      ),
    );
  }
  static Layout<Map<String, dynamic>> layout_({String? property}) {
...
class XCMVersionedXCMV3 extends XCMVersionedXCM {
  ...
  factory XCMVersionedXCMV3.fromJson(Map<String, dynamic> json) {
    ...
    return XCMVersionedXCMV3(
      xcm: XCMV3(
        instructions: data.map((e) => XCMInstructionV3.fromJson(e)).toList(),
      ),
    );
  }
...
class XCMVersionedXCMV4 extends XCMVersionedXCM {
  ...
  factory XCMVersionedXCMV4.fromJson(Map<String, dynamic> json) {
    ...
    return XCMVersionedXCMV4(
      xcm: XCMV4(
        instructions: data.map((e) => XCMInstructionV4.fromJson(e)).toList(),
      ),
    );
  }
...
class XCMVersionedXCMV5 extends XCMVersionedXCM {
  ...
  factory XCMVersionedXCMV5.fromJson(Map<String, dynamic> json) {
    ...
    return XCMVersionedXCMV5(
      xcm: XCMV5(
        instructions: data.map((e) => XCMInstructionV5.fromJson(e)).toList(),
      ),
    );
  }
  static Layout<Map<String, dynamic>> layout_({String? property}) {
...
abstract class XCMVersionedAssetId extends SubstrateVariantSerialization {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetIdV2.layout_(property: property),
        property: XCMVersion.v2.name,
        index: 2,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetIdV3.layout_(property: property),
        property: XCMVersion.v3.name,
        index: 3,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetIdV4.layout_(property: property),
        property: XCMVersion.v4.name,
        index: 4,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetIdV5.layout_(property: property),
        property: XCMVersion.v5.name,
        index: 5,
      ),
    ], property: property);
...
class XCMVersionedAssetIdV3 extends XCMVersionedAssetId {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV3AssetId.layout_(property: "asset"),
    ], property: property);
  }
...
class XCMVersionedAssetIdV2 extends XCMVersionedAssetId {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV2AssetId.layout_(property: "asset"),
    ], property: property);
  }
...
class XCMVersionedAssetIdV4 extends XCMVersionedAssetId {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV4AssetId.layout_(property: "asset"),
    ], property: property);
  }
...
class XCMVersionedAssetIdV5 extends XCMVersionedAssetId {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV5AssetId.layout_(property: "asset"),
    ], property: property);
  }
...
abstract class XCMVersionedAssets extends SubstrateVariantSerialization {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetsV2.layout_(property: property),
        property: XCMVersion.v2.name,
        index: 1,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetsV3.layout_(property: property),
        property: XCMVersion.v3.name,
        index: 3,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetsV4.layout_(property: property),
        property: XCMVersion.v4.name,
        index: 4,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedAssetsV5.layout_(property: property),
        property: XCMVersion.v5.name,
        index: 5,
      ),
    ], property: property);
...
abstract class XCMVersionedAsset extends SubstrateVariantSerialization {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      LazyVariantModel(
        layout: ({property}) => XCMVersionedAssetV2.layout_(property: property),
        property: XCMVersion.v2.name,
        index: XCMVersion.v2.version,
      ),
      LazyVariantModel(
        layout: ({property}) => XCMVersionedAssetV3.layout_(property: property),
        property: XCMVersion.v3.name,
        index: XCMVersion.v3.version,
      ),
      LazyVariantModel(
        layout: ({property}) => XCMVersionedAssetV4.layout_(property: property),
        property: XCMVersion.v4.name,
        index: XCMVersion.v4.version,
      ),
      LazyVariantModel(
        layout: ({property}) => XCMVersionedAssetV5.layout_(property: property),
        property: XCMVersion.v5.name,
...
class XCMVersionedAssetV2 extends XCMVersionedAsset {
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
      XCMV2MultiAsset.layout_(property: "asset"),
    ], property: property);
  }
...
abstract class XCMVersionedLocation extends SubstrateVariantSerialization
  ...
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.lazyEnum([
      ...
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedLocationV4.layout_(property: property),
        property: XCMVersion.v4.name,
        index: 4,
      ),
      LazyVariantModel(
        layout:
            ({property}) => XCMVersionedLocationV5.layout_(property: property),
        property: XCMVersion.v5.name,
        index: 5,
      ),
    ], property: property);
  ...
  XCMVersionedLocation asVersion(XCMVersion version) {
    ...
    return switch (version) {
      XCMVersion.v2 => XCMVersionedLocationV2(
        location: location.asVersion(version),
      ),
      XCMVersion.v3 => XCMVersionedLocationV3(
        location: location.asVersion(version),
      ),
      XCMVersion.v4 => XCMVersionedLocationV4(
        location: location.asVersion(version),
      ),
      XCMVersion.v5 => XCMVersionedLocationV5(
        location: location.asVersion(version),
      ),
    }.cast();
  }
  ...
  @override
  List get variables => [version, location];
}
...
class XCMVersionedLocationV2 extends XCMVersionedLocation {
  ...
  factory XCMVersionedLocationV2.fromJson(Map<String, dynamic> json) {
    return XCMVersionedLocationV2(
      location: XCMV2MultiLocation.fromJson(json.valueAs(XCMVersion.v2.type)),
    );
  }
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
...
class XCMVersionedLocationV3 extends XCMVersionedLocation {
  ...
  factory XCMVersionedLocationV3.fromJson(Map<String, dynamic> json) {
    return XCMVersionedLocationV3(
      location: XCMV3MultiLocation.fromJson(json.valueAs(XCMVersion.v3.type)),
    );
  }
  static Layout<Map<String, dynamic>> layout_({String? property}) {
    return LayoutConst.struct([
