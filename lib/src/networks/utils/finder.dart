...
class SubstrateNetworkControllerFinder {
  static BaseSubstrateNetworkController buildApi({
    ...
    return switch (network) {
          ...
          PolkadotNetwork.polkadotAssetHub => PolkadotAssetHubNetworkController(
            params: params,
          ),
          ...
          PolkadotNetwork.polkadotPeople => PolkadotPeopleNetworkController(
            params: params,
          ),
          PolkadotNetwork.polkadotCoretime => PolkadotCoretimeNetworkController(
            params: params,
          ),
          PolkadotNetwork.astar => AstarNetworkController(params: params),
          PolkadotNetwork.hydration => HydrationNetworkController(
            params: params,
          ),
          PolkadotNetwork.interlay => InterlayNetworkController(params: params),
          PolkadotNetwork.bifrostPolkadot => BifrostNetworkController(
            params: params,
          ),
          PolkadotNetwork.centrifuge => CentrifugeNetworkController(
            params: params,
          ),
          PolkadotNetwork.zeitgeist => ZeitgeistNetworkController(
            params: params,
          ),
          ...
          PolkadotNetwork.kiltSpiritnet => KILTSpiritnetNetworkController(
            params: params,
          ),
          ...
          PolkadotNetwork.energyWebX => EnergyWebXNetworkController(
            params: params,
          ),
          PolkadotNetwork.integritee => IntegriteeNetworkController(
            params: params,
          ),
          ...
          KusamaNetwork.kusamaBridgeHub => KusamaBridgeHubNetworkController(
            params: params,
          ),
          KusamaNetwork.encointer => EncointerNetworkController(params: params),
          KusamaNetwork.kusamaPeople => KusamaPeopleNetworkController(
            params: params,
          ),
          KusamaNetwork.kusamaCoretime => KusamaCoretimeNetworkController(
            params: params,
          ),
          KusamaNetwork.bifrostKusama => BifrostKusamaNetworkController(
            params: params,
          ),
          ...
          ///
          WestendNetwork.westendAssetHub => WestendAssetHubNetworkController(
            params: params,
          ),
          WestendNetwork.westend => WestendNetworkController(params: params),
          WestendNetwork.westendBridgeHub => WestendBridgeHubNetworkController(
            params: params,
          ),
          WestendNetwork.westendCollectives =>
            WestendCollectivesNetworkController(params: params),
          WestendNetwork.westendPeople => WestendPeopleNetworkController(
            params: params,
          ),
          WestendNetwork.westendCoretime => WestendCoretimeNetworkController(
            params: params,
          ),
          WestendNetwork.penpal => WestendPenpalNetworkController(
            params: params,
          ),

          ///
          PaseoNetwork.paseoAssetHub => PaseoAssetHubNetworkController(
            params: params,
          ),
          PaseoNetwork.paseo => PaseoNetworkController(params: params),
          PaseoNetwork.paseoBridgeHub => PaseoBridgeHubNetworkController(
            params: params,
          ),
          PaseoNetwork.paseoCollectives => PaseoCollectivesNetworkController(
            params: params,
          ),
          PaseoNetwork.paseoPeople => PaseoPeopleNetworkController(
            params: params,
          ),
          PaseoNetwork.paseoCoretime => PaseoCoretimeNetworkController(
            params: params,
          ),
          PaseoNetwork.hydration => HydrationPaseoNetworkController(
            params: params,
          ),
          _ =>
