...
abstract class BaseAjunaNetworkController<NETWORK extends BaseSubstrateNetwork>
    extends
        BaseSubstrateNetworkController<BigInt, BaseAjunaNetworkAsset, NETWORK> {
  @override
  ...
  Future<Map<BigInt, AjunaNetworkAsset>> _getAssets({
    ...
    final locations =
        await SubstrateNetworkControllerAssetQueryHelper.getAssetRegistryPalletAssetIdLocationEntriesIdentifierBigInt(
          provider,
  ...
  getAccountAssetsInternal({
    ...
    List<BaseAjunaNetworkAsset>? knownAssets,
  }) async {
