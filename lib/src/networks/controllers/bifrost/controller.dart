...
>
  ...
  Future<Map<Map<String, dynamic>, BifrostAssetMetadata>> _getMetadatas(
    ...
    final assetEntries =
        await SubstrateNetworkControllerAssetQueryHelper.getAssetRegistryPalletcurrencyMetadatasEntriesIdentifierMap(
          provider,
        );
  ...
  Future<List<BifrostNetworkAsset>> _getAssets({
    ...
    final locations =
        await SubstrateNetworkControllerAssetQueryHelper.getAssetRegistryPalletCurrencyIdToLocationsEntriesIdentifierMap(
          provider,
  ...
  getAccountAssetsInternal({
    ...
    List<BaseBifrostNetworkAsset>? knownAssets,
  }) async {
