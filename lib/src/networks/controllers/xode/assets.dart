...
abstract class BaseXodeNetworkAsset extends BaseSubstrateNetworkAsset {
  BaseXodeNetworkAsset(
  ...
  BaseXodeNetworkAsset.fromJson(super.json) : super.fromJson();
}

class XodeNetworkAsset extends BaseXodeNetworkAsset {
  ...
  factory XodeNetworkAsset.fromJson(Map<String, dynamic> json) {
...
class XodeNetworkNativeAsset extends BaseXodeNetworkAsset {
  @override
  final XCMVersionedLocation location;
  @override
  final Object? identifier = null;
  XodeNetworkNativeAsset(
  ...
  XodeNetworkNativeAsset.fromJson(super.json)
