...
import 'package:polkadot_dart/src/networks/controllers/crust/assets.dart';
...
abstract class BaseCrustNetworkController<NETWORK extends BaseSubstrateNetwork>
  ...
  Future<List<SubstrateAccountAssetBalance<BaseCrustNetworkAsset>>>
    ...
    Map<BigInt, CrustNetworkAsset> assets = {};
    for (final i in allAssets) {
      if (i is! CrustNetworkAsset) continue;
...
class CrustNetworkController
    extends BaseCrustNetworkController<PolkadotNetwork> {
  CrustNetworkController({required super.params});
