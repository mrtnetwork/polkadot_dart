...
>
  ...
  Map<BigInt, MoonbeamForeignAsset> _getAssetsConstants({
    ...
    List<MoonbeamForeignAsset> assets =
        MoonbeamNetworkControllerConst.defaultAssets(
          chainId,
        ).map((e) => MoonbeamForeignAsset.fromJson(e)).toList();
    if (assetIds != null) {
  ...
  _getMoonbeamForeignAssets({
    ...
    final assetsEntries =
        await SubstrateNetworkControllerAssetQueryHelper.getEvmForeignAssetsPalletIdentifierBigInt(
          provider: provider,
    ...
    final remainAssets = assetsEntries.entries.where(
      (e) => !contantAssets.containsKey(e.key),
    );
  ...
  getAccountAssetsInternal({
    ...
    List<BaseMoonbeamNetworkAsset>? knownAssets,
  }) async {
  ...
  Future<List<MoonbeamNetworkAsset>> getAssetsInternal({
    ...
    if (knownAssetIds == null || knownAssetIds.isNotEmpty) {
      ...
      final fees =
          await SubstrateNetworkControllerAssetQueryHelper.getXCMTransactorPalletDestinationFeePerSeconds(
            provider,
...
class MoonbeamNetworkController
  ...
  @override
  late final MoonbeamNetworkNativeAsset
  defaultNativeAsset = MoonbeamNetworkNativeAsset(
    decimals: 18,
    name: "Moonbeam",
    symbol: "GLMR",
    location:
        SubstrateNetworkControllerUtils.locationWithPalletInstanceAndAccountKey20(
