...
abstract class BaseEnergyWebXNetworkAsset extends BaseSubstrateNetworkAsset {
  BaseEnergyWebXNetworkAsset(
  ...
  BaseEnergyWebXNetworkAsset.fromJson(super.json) : super.fromJson();
}

class EnergyWebXNetworkAsset extends BaseEnergyWebXNetworkAsset {
  ...
  factory EnergyWebXNetworkAsset.fromJson(Map<String, dynamic> json) {
...
class EnergyWebXNetworkNativeAsset extends BaseEnergyWebXNetworkAsset {
  @override
  final XCMVersionedLocation location;
  @override
  ...
  EnergyWebXNetworkNativeAsset.fromJson(super.json)
