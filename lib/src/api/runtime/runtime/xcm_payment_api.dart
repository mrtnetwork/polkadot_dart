...
class SubstrateRuntimeApiXCMPayment extends SubstrateRuntimeApi {
  ...
  queryAcceptablePaymentAsset({
    ...
    final result = await callRuntimeApiInternal<Map<String, dynamic>>(
      method: SubstrateRuntimeApiXCMPaymentMethods.queryAcceptablePaymentAssets,
      api: api,
      provider: rpc,
      params: [version.version],
    );
    return SubstrateDispatchResult.fromJson<
      XCMVersionedAssetIds,
  ...
  Future<XCMVersionedAssetIds> tryQueryAcceptablePaymentAsset({
    ...
    final result = await queryAcceptablePaymentAsset(
      api: api,
      rpc: rpc,
      version: version,
    );
  ...
  Future<SubstrateDispatchResult<SubstrateWeightV2>> queryXcmWeight({
    ...
    return SubstrateDispatchResult.fromJson<
      SubstrateWeightV2,
      Map<String, dynamic>
    >(result, SubstrateWeightV2.fromJson);
  }
  ...
  Future<SubstrateDispatchResult<BigInt>> queryWeightToAssetFee({
    ...
    final result = await callRuntimeApiInternal<Map<String, dynamic>>(
      ...
      api: api,
      provider: rpc,
      params: [weight.toJson(), asset.toJson()],
    );
