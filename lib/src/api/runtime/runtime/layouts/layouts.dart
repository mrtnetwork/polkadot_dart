...
class SubstrateRuntimeApiConstants {
  static final Map<String, SubstrateRuntimeApiLayoutBuilder> apis =
      {
        SubstrateRuntimeApiDryRunMethods
            .dryRunCall
              ...
              onOk: ({property}) {
                return LayoutConst.struct([
                  ...
                  LayoutConst.compactVec(
                    api.typeLayoutByPathTail("RuntimeEvent"),
                    property: "emitted_events",
                  ),
                  MetadataUtils.optionalLayout(
                    ({property}) => api.typeLayoutByPathTail(
                      "VersionedXcm",
                      property: property,
                    ),
                    property: "local_xcm",
        ...
        SubstrateRuntimeApiXCMPaymentMethods
            .queryXcmWeight
            .method: SubstrateRuntimeApiLayoutBuilder(
          outputBuilder: (api, _) {
            return SubstrateDispatchResult.buildDispatchLayout(
              metadata: api,
              onOk: ({property}) {
                final layout = api.typeLayoutByPathTail(
                  "Weight",
                  property: property,
                );
                return layout;
        ...
        SubstrateRuntimeApiEthereumRuntimeRPCApisMethods
            .call
            .method: SubstrateRuntimeApiLayoutBuilder(
          outputBuilder: (api, _) {
            return SubstrateDispatchResult.buildDispatchLayout(
