...
class PalletCallMetadataV16 extends PalletCallMetadata {
  ...
  Layout<Map<String, dynamic>> layout({String? property}) {
    return SubstrateMetadataLayouts.palletCallMetadataV16(property: property);
  }
